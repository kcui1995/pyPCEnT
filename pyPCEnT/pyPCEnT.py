...
class pyPCEnT(object):
    ...
    def __init__(self, GSProtonPot, ReacProtonPot, ProdProtonPot, DonorEmLineshape, AcceptorAbsLineshape, ConvolKernel=None, Vel=0.0434, NStates=10, NGridPot=256, NGridLineshape=500, Smooth='fit_poly6', **kwargs):
        ...
        *** Initialization ***
        ...
        By default, the proton potentials will be fitted to an 6th-order polynomial, while the line shape functions will be fitted as a sum of Gaussian functions. 
    ...
    def calc_proton_vibrational_states(self, mass=massH):
        ...
        for proton moving in GSProtonPot, ReacProtonPot, and ProdProtonPot respectively. 
